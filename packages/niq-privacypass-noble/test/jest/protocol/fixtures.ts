...
import { IssueRequestDes } from '../../../src/protocol/types/des'
...
export const issueRequestUntyped: {
  bF: bigint[]
  tokens: Uint8Array[]
  bP: Point[]
} = {
...
export const issueRequestDes: IssueRequestDes = {
  contents: issueRequestUntyped.bP
}

export const issueResponseRaw =
...
export const wrappedIssueRequest = JSON.stringify({
  bl_sig_req:
...
export const serverKey =
  0x216e3912d4d33b2528b408dedbe72a9b3f0128bcc4e47837129eb0807b8a6ab2n

export const wrappedRedeemRequest = `{"bl_sig_req":"eyJ0eXBlIjoiUmVkZWVtIiwiY29udGVudHMiOlsiYlRPRERPVldrTlVXOFZLKzRhOEQxd3ViTXR6ODA0R0JQTTRlWUV0MElJZz0iLCJPZjBUL2tneWpVRk1mVlY0TUtwY1E3d2JmcnZVYWgvTUU1dDc3dmRoczNZPSJdfQ=="}`
