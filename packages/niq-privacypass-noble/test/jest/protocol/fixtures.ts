...
export const issueTokenRequest: {
  bF: bigint[]
  tokens: Uint8Array[]
  bP: Point[]
} = {
...
export const wrappedIssueTokenRequest = JSON.stringify({
  bl_sig_req:
...
export const wrappedRedeemTokenRequest = `{"bl_sig_req":"eyJ0eXBlIjoiUmVkZWVtIiwiY29udGVudHMiOlsiYlRPRERPVldrTlVXOFZLKzRhOEQxd3ViTXR6ODA0R0JQTTRlWUV0MElJZz0iLCJPZjBUL2tneWpVRk1mVlY0TUtwY1E3d2JmcnZVYWgvTUU1dDc3dmRoczNZPSJdfQ=="}`
